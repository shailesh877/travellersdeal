...
import { FaArrowLeft, FaCheckCircle, FaTimesCircle, FaMapMarkerAlt, FaClock, FaTag, FaLanguage, FaUserFriends, FaCheck, FaTimes, FaCalendarAlt, FaUtensils, FaSyncAlt } from 'react-icons/fa';
        ...
        <div className="min-h-screen bg-gray-50 pt-20 p-8 font-sans">
            <div className="container mx-auto max-w-4xl">
                <div className="flex flex-col sm:flex-row sm:items-center justify-between mb-6 gap-4">
                    ...
                    <button 
                        onClick={() => { setLoading(true); fetchExperience(); }} 
                        disabled={loading}
